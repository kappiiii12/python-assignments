...
4. Write a Python script to print "Teacher's Day" on the screen. (Remember to print double quotes and single quote)

5. Write a python script to print \n on the screen."""
 #solution1 print("mysirg")
# solution2 print("mysirg\neducation services")
#solution3 print("\"mysirg\"")
#solution4 print("\"teacher's day\"")
#solution5 
print("\\n")